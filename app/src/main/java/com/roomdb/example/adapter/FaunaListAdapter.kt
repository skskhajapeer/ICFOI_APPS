 ...
 * @author Antonina
 */
class FaunaListAdapter(private val parent: Activity) : RecyclerView.Adapter<FaunaListAdapter.MoviesViewHolder>() {

    private val layoutInflater: LayoutInflater = LayoutInflater.from(parent)
    private var movieList: List<LoginTableModel>? = null

    fun setMovieList(movieList: List<LoginTableModel>?) {
    ...
    override fun onBindViewHolder(holder: MoviesViewHolder, position: Int) {
        movieList?.let { list ->
            ...
            holder.tvDistrict.text = movie.Username
            holder.tvSite.text=movie.Password
